...
class TowerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // create a new scene
        let scene = SCNScene(named: "art.scnassets/wooden watch tower2.scn")!
        scene.rootNode.geometry?.firstMaterial?.diffuse.contents = #imageLiteral(resourceName: "aaa.jpg")
